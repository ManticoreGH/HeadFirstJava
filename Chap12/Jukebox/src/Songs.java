...
public class Songs {
    public List<Song> getSongs() {
        return  List.of(
            ...
            new Song("Hurt", "Johnny Cash", "Soft Rock", 2002, 245),
            new Song("Watercolour", "Pendulum", "Electronic", 1995, 155),
            ...
            new Song("What's Going on", "Marvin Gaye", "R&B", 1971, 420),
            new Song("Hallucinate", "Dua Lipa", "Pop", 2020, 75),
            new Song("Walk Me Home", "P!nk", "Pop", 2019, 459),
            new Song("I am not a woman, I'm a god", "Halsey", "Alternative Rock", 2011, 384),
            new Song("Pasos de cero", "Pablo Alborán", "Latin", 1999, 244),

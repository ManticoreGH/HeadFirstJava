...
public class MockMoreSongs {
	public static List<Song> getSongs() {
		...
		songs.add(new Song("somersault", "zero 7", 50));
		songs.add(new Song("cassidy", "grateful dead", 65));
		songs.add(new Song("$10", "hitchhiker", 80));
		songs.add(new Song("havana", "cabello", 60));
		songs.add(new Song("$10", "hitchhiker", 80));
		songs.add(new Song("cassidy", "grateful dead", 65));
		songs.add(new Song("50 ways", "simon", 70));
		return songs;
	}
